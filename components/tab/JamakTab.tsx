...
import { analyzeIsimFail, analyzeIsimMafulPlural, analyzeIsimZamanMakanPlural, analyzeIsimAlatPlural } from "@/utils/jamakEngine";
...
export default function JamakTab({ entry, tc, isPremium, onUnlock }: Props) {
  ...
  const failData: PluralIsimFail = analyzeIsimFail(entry);
